...
MODULE("@(#)TradeXpress $Id: initbaseora.c 47371 2013-10-21 13:58:37Z cdemory $")
/*========================================================================
...
init_bases()
{
	/* Temporarily removed for WNT (KP) */
	init_base(init_odbsysops); /* ODB libraries. */
