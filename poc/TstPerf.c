...
debughook(20,0);
tr_FileWrite(stdout,"%s%s%s%s%s%s",tr_PrintNum(tr_lsGetNumVal(&SYSLOG,&lfh_1_3),NULL,0,0,0)," ",tr_lsGetTextVal(&SYSLOG,&lfh_1_1)," ",tr_PrintNum(tr_lsGetNumVal(&SYSLOG,&lfh_1_2),NULL,0,0,0),TR_NEWLINE);
debughook(22,0);
